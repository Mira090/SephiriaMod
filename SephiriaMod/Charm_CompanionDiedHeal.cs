...
namespace SephiriaMod
{
    public class Charm_CompanionDiedHeal : Charm_Basic
    {
        ...
        protected override void OnEnabledEffect()
        {
            ...
            base.NetworkAvatar.OnFollowerAddedServerside += OnFollowerAdded;
            base.NetworkAvatar.OnFollowerRemovedServerside += OnFollowerRemoved;
            foreach (UnitAvatar follower in base.NetworkAvatar.Followers)
