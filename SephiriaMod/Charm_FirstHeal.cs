...
namespace SephiriaMod
{
    public class Charm_FirstHeal : Charm_StatusInstance
    {
        ...
        public override Loc.KeywordValue[] BuildKeywords(UnitAvatar avatar, int level, int virtualLevelOffset, bool showAllLevel, bool ignoreAvatarStatus)
        {
            ...
            {
            new Loc.KeywordValue("HEAL", healPercent + "%", Charm_Basic.GetPositiveColor(virtualLevelOffset))
            };
        }
        private void Awake()
        {
        ...
        public override void SaveItemOnServer(ISaveData saveData)
        {
            ...
            saveData.SetBool($"CharmSaveData_FirstHeal_{base.Item.InstanceID}_Stack", heal);
        }
        public override void LoadItemOnServer(ISaveData saveData)
        {
            base.LoadItemOnServer(saveData);
            heal = saveData.GetBool($"CharmSaveData_FirstHeal_{base.Item.InstanceID}_Stack", false);
        }
    }
}
