...
namespace SephiriaMod.Utilities
{
    ...
    {
        public static readonly List<string> PlanetDamageIds = ["Charm_Planet_Black", "Charm_Planet_Yellow", "Charm_Planet_White", "Charm_Planet_Red", "Charm_Planet_Blue", "Charm_Planet_Sky", "Charm_Planet_Gray"];
