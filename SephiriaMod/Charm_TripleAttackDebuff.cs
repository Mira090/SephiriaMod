...
namespace SephiriaMod
{
    public class Charm_TripleAttackDebuff : Charm_VariableMaxLevel
    {
        ...
        public override Loc.KeywordValue[] BuildKeywords(UnitAvatar avatar, int level, int virtualLevelOffset, bool showAllLevel, bool ignoreAvatarStatus)
        {
            ...
            {
            new Loc.KeywordValue("INTERVAL", value, Charm_Basic.GetPositiveColor(virtualLevelOffset))
            };
        }
        ...
        public override void SaveItemOnServer(ISaveData saveData)
        {
            ...
            saveData.SetInt($"CharmSaveData_TripleAttackDebuff_{base.Item.InstanceID}_Stack", type);
        }

        public override void LoadItemOnServer(ISaveData saveData)
        {
            base.LoadItemOnServer(saveData);
            type = saveData.GetInt($"CharmSaveData_TripleAttackDebuff_{base.Item.InstanceID}_Stack", 0);
        }
