...
namespace SephiriaMod
{
    public class Charm_WoundWeapon : Charm_StatusInstance
    {
        ...
        public override Loc.KeywordValue[] BuildKeywords(UnitAvatar avatar, int level, int virtualLevelOffset, bool showAllLevel, bool ignoreAvatarStatus)
        {
            ...
            {
            new Loc.KeywordValue("STACK", "+" + value, Charm_Basic.GetPositiveColor(virtualLevelOffset)),
            new Loc.KeywordValue("COST", "-" + cost + "%", Charm_Basic.GetPositiveColor(virtualLevelOffset)),
        ...
        public override void SaveItemOnServer(ISaveData saveData)
        {
            ...
            saveData.SetInt($"CharmSaveData_WoundWeapon_{base.Item.InstanceID}_Stack", count);
        }

        public override void LoadItemOnServer(ISaveData saveData)
        {
            base.LoadItemOnServer(saveData);
            count = saveData.GetInt($"CharmSaveData_WoundWeapon_{base.Item.InstanceID}_Stack", 0);
        }
    }
}
