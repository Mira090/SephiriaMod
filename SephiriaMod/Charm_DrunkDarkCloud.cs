...
namespace SephiriaMod
{
    public class Charm_DrunkDarkCloud : Charm_StatusInstance
    {
        ...
        public override Loc.KeywordValue[] BuildKeywords(UnitAvatar avatar, int level, int virtualLevelOffset, bool showAllLevel, bool ignoreAvatarStatus)
        {
            ...
            {
            new Loc.KeywordValue("SPEED", value + "%", Charm_Basic.GetNegativeColor(virtualLevelOffset)),
            new Loc.KeywordValue("SERIES", "+" + value2, Charm_Basic.GetPositiveColor(virtualLevelOffset)),
            new Loc.KeywordValue("ADDITION", "+" + value3, Charm_Basic.GetPositiveColor(virtualLevelOffset))
            };
        }
