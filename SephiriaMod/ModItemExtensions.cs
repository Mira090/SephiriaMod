...
namespace SephiriaMod
{
    public static class ModItemExtensions
    {
        ...
        public static Miracle_StatusInstance.Effect CreateEffect(string effect, EEffectType effectType)
        {
            return new Miracle_StatusInstance.Effect() { effectString = new LocalizedString(effect), effectType = effectType };
        }
        public static Miracle_StatusInstance.Effect CreatePositiveEffect(string effect)
        {
            return new Miracle_StatusInstance.Effect() { effectString = new LocalizedString(effect), effectType = EEffectType.Positive };
        }
        public static Miracle_StatusInstance.Effect CreateNegativeEffect(string effect)
        {
            return new Miracle_StatusInstance.Effect() { effectString = new LocalizedString(effect), effectType = EEffectType.Negative };
        }
        public static Miracle_StatusInstance.Effect CreateNeutralEffect(string effect)
        {
            return new Miracle_StatusInstance.Effect() { effectString = new LocalizedString(effect), effectType = EEffectType.Neutral };
        }
