...
namespace SephiriaMod
{
    public static class CustomCostumeDatabase
    {
        ...
        {
            CustomCostumeDatabase.costumeDictionary = new Dictionary<string, CustomCostumeEntity>();
            ...
            {
                CustomCostumeDatabase.costumeDictionary[costumeEntity.id] = costumeEntity;
        ...
        {
            CustomCostumeDatabase.costumeDictionary = null;
        ...
        public static CustomCostumeEntity FindCostumeByID(string id)
        {
            ...
            if (CustomCostumeDatabase.costumeDictionary.TryGetValue(id, out result))
            {
                return result;
            }
            return null;
        ...
        {
            return CustomCostumeDatabase.costumeDictionary.Values;
        }
