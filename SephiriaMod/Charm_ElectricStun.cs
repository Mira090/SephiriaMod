...
namespace SephiriaMod
{
    public class Charm_ElectricStun : Charm_StatusInstance
    {
        ...
        public override Loc.KeywordValue[] BuildKeywords(UnitAvatar avatar, int level, int virtualLevelOffset, bool showAllLevel, bool ignoreAvatarStatus)
        {
            ...
            new Loc.KeywordValue("CURRENT", value2, Charm_Basic.GetPositiveColor(virtualLevelOffset))
            };
        }
        ...
        protected override void OnEnabledEffect()
        {
            ...
            base.NetworkAvatar.SetEffectHUDValue(GetCharmHUDID(), $"{Mathf.Min(100, countView * percentByLevel.SafeRandomAccess(CurrentLevelToIdx()))}/{100}");
        }
        ...
        protected override void OnUpdatedLevel(int oldLevel, int newLevel)
        {
            ...
            base.NetworkAvatar.SetEffectHUDValue(GetCharmHUDID(), $"{Mathf.Min(100, countView * percentByLevel.SafeRandomAccess(LevelToIdx(newLevel)))}/{100}");
        }
        public override void SaveItemOnServer(ISaveData saveData)
        {
            base.SaveItemOnServer(saveData);
            saveData.SetInt($"CharmSaveData_ElectricStun_{base.Item.InstanceID}_Stack", count);
        }

        public override void LoadItemOnServer(ISaveData saveData)
        {
            base.LoadItemOnServer(saveData);
            count = saveData.GetInt($"CharmSaveData_ElectricStun_{base.Item.InstanceID}_Stack", 0);
            countView = count;
            ModEvent.CommandValue(NetworkAvatar, Item, countView);
        }
    }
